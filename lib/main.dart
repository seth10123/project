...
void main() => runApp(MaterialApp(initialRoute: '/homescreen', routes: {
      '/homescreen': (context) => LoginPage(),
    }));
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget todoType(String icontype) {
    ...
    switch (icontype) {
      case 'Feeding left':
        iconval = FontAwesomeIcons.arrowLeft;
        colorval = Color(0xff4158ba);
        break;
      case 'Feeding right':
        iconval = FontAwesomeIcons.arrowRight;
        colorval = Color(0xfffb537f);
        break;
      case 'Sleeping':
        iconval = FontAwesomeIcons.bed;
        colorval = Color(0xff4caf50);
        break;
      case 'Diapering':
        iconval = FontAwesomeIcons.baby;
        colorval = Color(0xff9962d0);
        break;
      default:
        iconval = FontAwesomeIcons.babyCarriage;
